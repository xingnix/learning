...
#+TITLE:  线性系统校正方法
#+latex_header: \subtitle{系统设计与串联校正}
#+AUTHOR:    
#+EMAIL: 
#+DATE:  
#+DESCRIPTION:
...
* 系统的设计与校正
#+include: "6_1_corrector.org" :lines "60-"
* 串联超前校正
#+include: "6_2_lead.org" :lines "60-"
* 串联滞后校正
#+include: "6_3_lag.org" :lines "60-"
* 串联滞后-超前校正
#+include: "6_4_laglead.org" :lines "60-"
* 串联综合法校正
#+include: "6_5_synthesize.org" :lines "60-"
* 反馈校正
#+include: "6_6_feedback.org" :lines "60-"
* 复合校正
#+include: "6_7_compound.org" :lines "60-"
