...
\includegraphics[width=0.3\textwidth]{./image/coins.png}
\includegraphics[width=0.3\textwidth]{./image/coins_periodic_noise.png}
\includegraphics[width=0.3\textwidth]{./image/coins_periodic_filted.png}
\end{frame}
\end{document}
