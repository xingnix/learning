...
\section{AI历史}
\label{sec:org8e7dd3f}

\begin{frame}[label={sec:org427a9ef}]{幻想中的AI}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/1757126005661qhgmmo2v.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org6ff81e8}]{AI的梦想}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/1757126255123zb33yfo0.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgc9f7408}]{AI的翅膀}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/magicstudio-art.jpg}
\end{center}
\end{frame}
\begin{frame}[label={sec:org1589be0}]{AI与飞行}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/image.jpeg}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgb7cb6d6}]{The Engine in Jonathan Swift’s  Gulliver’s Travels}
\begin{center}
\includegraphics[width=0.7\textwidth]{./image/magic-hour-ai-gulliver-engine.png}
\end{center}

\url{https://magichour.ai/products/ai-image-generator}
\end{frame}
\begin{frame}[label={sec:org894437c}]{chess-playing machine , Leonardo Torresy Quevedo}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/080224_Bruderer_Fig.-7-Wiener_Torres-Quevedo-1951-1.jpg}
\end{center}

\url{https://cacm.acm.org/blogcacm/technical-marvels-part-5-chess-automatons/}
\end{frame}
\begin{frame}[label={sec:org11d8e76}]{A play named R.U.R (Rossum’s Universal Robots) opens in London.}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/scene-from-rur-rossums-universal-robots-by-karel-capek-guild-tour-company-museum-private-collection-author-vandamm-studio-R5MMRE.jpeg}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgd7ea7f2}]{Alan-Turing}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/Alan-Turing.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org820dfcb}]{John Mccarthy}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/john-mccarthy-stanford.jpg}
\end{center}
\end{frame}
\section{课程简介}
\label{sec:orgb8dcc59}

\begin{frame}[label={sec:orgb9c9f71}]{机器学习}
\begin{block}{定义}
对于某类任务 \(T\) 和性能度量 \(P\) 如果一个计算机程序在T上以P衡量的性能随着经验E而自我完善，那么我们称这个计算机程序在从经验E学习。
\end{block}
\end{frame}
\begin{frame}[label={sec:org2eca1f2}]{课程主要内容}
\begin{itemize}
\item 概念学习
\item 决策树学习
\item 人工神经网络
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2b28887}]{与其它课程关系}
\begin{itemize}
\item 概率与数理统计
\item 人工智能
\item 模式识别
...
\end{frame}
\section{机器学习示例}
\label{sec:orge9c5b1e}
\begin{frame}[label={sec:org440d175}]{机器学习示例}
\begin{itemize}
\item 无人驾驶汽车
\item 手写识别
\item 人脸识别
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org813b965}]{Typical Datamining Task}
\begin{center}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgbc4c45b},fragile]{Datamining Result}
 \begin{itemize}
\item Data:
\end{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb2b325f},fragile]{Credit Risk Analysis}
 Data:
...
\end{verbatim}
\end{frame}
\begin{frame}[label={sec:orge3886c8}]{Customer purchase behavior:}
\begin{center}
\includegraphics[width=.9\linewidth]{./image/customer-outcomes.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org3467e5c}]{Customer retention:}
\begin{center}
\includegraphics[width=.9\linewidth]{./image/bank-customer.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:orgfcdd688}]{Process optimization:}
\begin{center}
\includegraphics[width=.9\linewidth]{./image/process-outcomes.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org72bd803}]{ALVINN [Pomerleau] drives 70 mph on highways}
...
\end{frame}
\begin{frame}[label={sec:orgd291f27}]{Software that Customizes to User}
\center
\begin{center}
\includegraphics[height=0.7\textheight]{./image/wisewire.png}
\end{center}

\centerline{http://www.wisewire.com}
\end{frame}
\section{学习问题的标准描述}
\label{sec:org166ba60}
\begin{frame}[label={sec:org39ad0a5}]{定义}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2e3de9b}]{西洋跳棋学习问题：}
\begin{itemize}
\item 任务T：下西洋跳棋
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4788ae0}]{}
\begin{center}
\includegraphics[width=0.7\textwidth]{./image/draughts.png}
\end{center}

\url{https://draughts.org/}
\end{frame}
\begin{frame}[label={sec:org6f4d73a}]{手写识别学习问题}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge525fa1}]{}
\begin{center}
\includegraphics[width=0.8\textwidth]{./image/mnist.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org0af0eca}]{机器人驾驶学习问题}
\begin{itemize}
\item 任务T：通过视觉传感器在路上驾驶
\item 性能标准P：平均无差错行驶里程（差错由人类的监督裁定）
\item 训练经验E：注视人类驾驶时录制的一系列图像和驾驶指令
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3aca658}]{}
\begin{center}
\includegraphics[width=0.7\textwidth]{./image/tesla-autopilot-full-self-driving-fsd-1400x933.jpeg}
\end{center}
\end{frame}
\section{设计一个学习系统}
\label{sec:org98fd8df}


\begin{frame}[label={sec:orgc1943ac}]{西洋跳棋学习问题：}
\begin{itemize}
\item 任务T：下西洋跳棋
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgd45e38e}]{选取训练经验的类型}
\begin{itemize}
\item 直接或间接
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgc559305}]{选择目标函数}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org0e400c0}]{定义目标函数（ \(V\) ）}
\begin{itemize}
\item 例：
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7c61b54}]{选择目标函数表示}
\begin{itemize}
\item 一组规则
\item 神经网络
\item 棋盘状态的多项式函数
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org47af54f}]{目标函数表示}
\begin{eqnarray*}
&&\sum_{i=0}^6 w_i f_i \\
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfc80ebb}]{估计训练值}
\begin{itemize}
\item \(V(b)\): 真实目标函数
\item \(\hat{V}(b)\) : 学习到的函数
\item \(V_{train}(b)\): 训练值
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org4b271d0}]{权值调整}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgebce476}]{最终设计}
\center
\begin{center}
\includegraphics[height=0.7\textheight]{./image/intro-final-design.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org099e9e2}]{最终设计}
\begin{itemize}
...
\end{frame}
\begin{frame}[label={sec:org9d9cd16}]{设计过程}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/intro-f1.png}
\end{center}
\end{frame}
\section{机器学习的问题}
\label{sec:org59d022e}
...
\end{itemize}
\section{机器学习相关资源}
\label{sec:orge8a9e9a}

\begin{frame}[label={sec:org1159f5f}]{课程}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org3a0b684}]{资料}
\begin{itemize}
...
\end{frame}
\section{工具}
\label{sec:orgb66f138}
\begin{frame}[label={sec:org835067e}]{C/C++}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org2a9758d}]{Lua}
\begin{itemize}
\item \url{http://torch.ch}
\item \url{https://github.com/torchnet/}
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org250755b}]{Python}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf8d3740}]{Scikit-learn}
\begin{center}
\includegraphics[height=0.7\textheight]{./image/ml_map.png}
\end{center}
\end{frame}
\begin{frame}[label={sec:org7cd0415}]{Java}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgf46e2d4}]{科学计算}
\begin{itemize}
\item Rstudio(R)
\item Matlab/Octave
\item Scilab
