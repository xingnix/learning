...
<style|<tuple|beamer|chinese|old-dots|old-lengths|manila-paper>>
...
<\body>
  <screens|<\hidden>
    ...
    <tit|\<#4E0E\><math|t<rsub|n>y<rsub|i><around*|(|x<rsub|n>|)>>\<#6709\>\<#5173\>\<#7684\>\<#5316\>\<#7B80\>\<#65B9\>\<#6CD5\>>
    ...
    <tit|\<#6C42\>\<#89E3\><math|y<rsub|i><around*|(|\<cdot\>|)>>>

    \;

    \<#5C06\>E\<#770B\>\<#4F5C\><math|y<rsub|i><around*|(|\<cdot\>|)>>\<#7684\>\<#51FD\>\<#6570\>
    ...
    <tit|\<#6C42\>\<#89E3\><math|\<alpha\>>>

    <\folded-std>
      \;

      <\eqnarray*>
        <tformat|<table|<row|<cell|<frac|\<partial\>E|\<partial\>\<alpha\><rsub|i>>>|<cell|=>|<cell|-<frac|1|2><big|sum><rsub|n=1><rsup|N>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|-<frac|1|2>\<alpha\><rsub|i>t<rsub|n>y<rsub|i><around*|(|x<rsub|n>|)>>t<rsub|n>y<rsub|i><around*|(|x<rsub|n>|)>>>>>
      </eqnarray*>
    <|folded-std>
      <\eqnarray*>
        <tformat|<table|<row|<cell|0>|<cell|=>|<cell|<big|sum><rsub|n=1><rsup|N>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|-<frac|1|2>\<alpha\><rsub|i>t<rsub|n>y<rsub|i><around*|(|x<rsub|n>|)>>t<rsub|n>y<rsub|i><around*|(|x<rsub|n>|)>>>|<row|<cell|0>|<cell|=>|<cell|<big|sum><rsub|n\<in\>T>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|-<frac|1|2>\<alpha\><rsub|i>>-<big|sum><rsub|n\<in\>F>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|<frac|1|2>\<alpha\><rsub|i>>>>|<row|<cell|<big|sum><rsub|n\<in\>F>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|<frac|1|2>\<alpha\><rsub|i>>>|<cell|=>|<cell|<big|sum><rsub|n\<in\>T>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|-<frac|1|2>\<alpha\><rsub|i>>>>|<row|<cell|<big|sum><rsub|n\<in\>F>w<rsub|n><rsup|<around*|(|i|)>>e<rsup|\<alpha\><rsub|i>>>|<cell|=>|<cell|<big|sum><rsub|n\<in\>T>w<rsub|n><rsup|<around*|(|i|)>>>>>>
      </eqnarray*>
    </folded-std>
    ...
    <\eqnarray*>
      <tformat|<table|<row|<cell|e<rsup|\<alpha\><rsub|i>>>|<cell|=>|<cell|<frac|<big|sum><rsub|n\<in\>T>w<rsub|n><rsup|<around*|(|i|)>>|<big|sum><rsub|n\<in\>F>w<rsub|n><rsup|<around*|(|i|)>>>>>|<row|<cell|>|<cell|=>|<cell|<frac|<big|sum><rsub|n=1><rsup|N>w<rsub|n><rsup|<around*|(|i|)>>-<big|sum><rsub|n\<in\>F><rsup|>w<rsub|n><rsup|<around*|(|i|)>>|<big|sum><rsub|n\<in\>F><rsup|>w<rsub|n><rsup|<around*|(|i|)>>>>>>>
    </eqnarray*>
  </hidden>|<\shown>
    <tit|\<#6C42\>\<#89E3\><math|w<rsub|n><rsup|<around*|(|i|)>>>>
